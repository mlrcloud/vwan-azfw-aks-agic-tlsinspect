...
var agwAksResourceGroupName = 'rg-agwAks'
...
/* 
  Agw and AKS spoke resources
*/

param centrilazedResolverDnsOnAgwAksVnet bool = false
...
module agwAksSpokeResources 'agwAksSpokeResources.bicep' = {
  scope: agwAksResourceGroup
  name: 'agwAksSpokeResources_Deploy'
  dependsOn: [
    sharedResources
  ]
  params: {
    location:location
    tags: tags
    vnetInfo: vnetsInfo.agwAks.vnet 
    snetsInfo: vnetsInfo.agwAks.snets
...
module mngmntResources '../base/mngmnt/mngmntResources.bicep' = {
  ...
  params: {
    ...
    aksResourceGroupName: agwAksResourceGroupName
    ...
    agwResourceGroupName: agwAksResourceGroupName
    agwName: agwName
  }
}
          ...
          rules: [
            {
              ...
              terminateTLS: true
              sourceAddresses: [
                vnetsInfo.agwAks.snets[1].range
              ]
  ...
  ruleCollections: [
    {
      ...
      rules: [
        ...
        }
        {
          ruleType: 'NetworkRule'
          sourceAddresses: [
            vnetsInfo.agwAks.snets[0].range
          ]
          destinationAddresses: [
            '*'
          ]
...
var hubVnetConnectionsInfo = [
  ...
  {
    name: 'agwAKSconn'
    remoteVnetName: vnetsInfo.agwAks.vnet.name
    resourceGroup: agwAksResourceGroupName
    enableInternetSecurity: true
  }
  {
    name: 'mngmntconn'
